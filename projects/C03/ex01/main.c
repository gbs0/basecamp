...
int main(void) {
    ...
    char *original = "abcef";
    char *diff = "abcd";
    char *original1 = "abcde";
    char *diff1 = "abcdf";
    printf("ft_strncmp\t= %d\nstrncmp:\t= %d", ft_strncmp(original, diff, 4), strncmp(original, diff, 4));
    printf("\nft_strncmp\t= %d\nstrncmp:\t= %d", ft_strncmp(original1, diff1, 4), strncmp(original1, diff1, 4));

	offset = 0;
	printf("\n[1] Testing strings \"%s\" and \"%s\"\n", s1, s2);
	while (offset < 10)
	{
